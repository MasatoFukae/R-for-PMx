...
$THETA 0 FIXED ; CL_IPCRCL1
$THETA 0 FIXED ; CL_IPWT1
$THETA 0 FIXED ; CL_RLCRCL1
$THETA 0 FIXED ; V1_IPHLTH1
$THETA 0 FIXED ; V1_IPWT1
$THETA 0 FIXED ; V1_RLWT1
...
CRCL RENL WT WTBN AGE MALE HLTH HT RACE SECR RICH NROW CWRES TRT ONEHEADER NOPRINT FORMAT=s1PE13.7 FILE=mytab61
;
$TABLE ID NROW PN DRUG DOSE DAY RNTM TIME TSLD IPRED IRES IWRES CWRES DV ONEHEADER NOPRINT FORMAT=s1PE13.7 FILE=sdtab61
$TABLE ID CL_IP V1_IP Q_IP V2_IP CL_RL V1_RL Q_RL V2_RL
ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7 ETA8 NOAPPEND ONEHEADER NOPRINT FORMAT=s1PE13.7 FILE=patab61
$TABLE ID MALE HLTH RENL WTBN RACE ONEHEADER NOPRINT NOAPPEND FORMAT=s1PE13.7 FILE=catab61
$TABLE ID CRCL WT AGE HT SECR NOAPPEND ONEHEADER NOPRINT FORMAT=s1PE13.7 FILE=cotab61
